...
return (
  <>
    < section className="antialiased bg-neutral-800/20  absolute px-[1rem] shadow- [0_35px_60px_-15px_rgba(0,0,0,0.3)] font-serif rounded m-[20px] h-[90vh]  w-[90vw] max-sm:p-[0.4rem]  max-sm:m-[0.4rem] max-sm:relative " >
           <Header  />
          <div className=' flex m-auto items-center justify-center  h-[90%] max-md:h-[80%] p-[2rem] max-sm:p-[1rem] ' >
            <div className=' p-[1rem] space-y-[3rem]  max-lg:m-auto max-sm: p-[0.3rem]  '>
          ...
          <div className=' text-[2rem] w-fit h-fit flex absolute bottom-[1rem]  right-[40%] max-md:bottom-[1.5rem]  max-lg:right-[33%]  h-[2rem] text-[#dce0e0] space-x-[3rem] max-md:right-[23%] max-sm:bottom-[1.5rem] max-sm:right-[10%]'>
