...
function footer() {
  ...
  return (
    <>
    <div className='fixed bottom-[0.5rem] animate-pulse text-white text-[1rem]  flex justify-center w-[98vw] max-md:overflow-auto z-[1] max-md:bottom-[0rem]  max-md:pl-[20rem] max-md:pt-[-3rem '>
    {buttons.map((x,index)=>(
